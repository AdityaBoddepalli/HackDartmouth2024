...
hoistedDependencies:
  ...
  /@commitlint/load/18.4.4(@types/node@20.8.10)(typescript@5.2.2):
  ...
  /cosmiconfig-typescript-loader/5.0.0(@types/node@20.8.10)(cosmiconfig@8.3.6)(typescript@5.2.2):
  ...
  /vite-node/1.2.2(@types/node@20.8.10)(sass@1.72.0):
    vite-node: private
...
pendingBuilds: []
prunedAt: Thu, 18 Apr 2024 19:48:46 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
